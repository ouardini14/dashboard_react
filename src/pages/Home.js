    ...
    return (
        <div className=" py-10 space-y-9  ">
            <div className="flex justify-around items-center px-12">
                <div className="flex justify-around items-center bg-white text-black px-5 py-4 rounded-xl  gap-3">
                    ...
                    <span className="h-9 w-1 bg-gray-600"></span>
            ...
            <div className=" w-full flex justify-center px-12">
                <div className="flex justify-around items-center   px-5 py-4 bg-slate-100 rounded-xl  w-fit gap-20">
                    <div className="cursor-pointer rounded-lg  px-5 py-2  hover:bg-secondary/10 hover:text-secondary transition-all ease-in-out duration-300 ">
                        Documents courants
                    </div>
